            ...
            <ul className="flex flex-wrap justify-center gap-3 md:items-stretch md:gap-x-5 md:gap-y-[34px] lg:justify-start">
                {items.map((name) => (
                    <li
                        ...
                        className="tag-lg flex min-h-[52px] w-[calc(50%-6px)] items-center justify-center break-keep border border-cocoa px-2 py-2 text-center text-[18px] text-cocoa sm:text-[20px] md:w-auto md:min-h-[67px] md:px-[24px] md:text-[30px]"
                    >
                        {name}
                    </li>
                ))}
