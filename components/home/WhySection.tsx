...
export default function WhySection() {
    ...
    return (
        <section ref={ref} className="relative bg-sand h-[200dvh]">
            <div className="sticky top-[100px] container-site flex flex-col h-[calc(100dvh-100px)] lg:grid lg:grid-cols-[1fr_1.6fr]">
                {/* 타이틀 영역 */}
